...
query2 = """select a.name , v.views from authors a,
author_rank v where a.id = v.author;"""

# 3. On which days did more than 1% of requests lead to errors ?
query3 = """select  e.date , round(e.err_num * 100.0 /a.num,2)
as percent from error_logs e ,all_logs a where e.date =
a.date and e.err_num > a.num/100 order by percent desc;"""
